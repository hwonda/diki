...
const InternalLinkSearch = ({ onSelect, refocus = false, inputRef, onTabToNext }: InternalLinkSearchProps) => {
  ...
  return (
    <div className="w-full">
      <div className="w-full p-2 border border-gray4 rounded-md focus-within:border-primary bg-white dark:bg-black">
        <div className="flex items-center">
          ...
          <input
            ...
            className="w-full outline-none text-main bg-white dark:bg-black"
            data-search-input
          />
          {searchQuery && (
            <X
