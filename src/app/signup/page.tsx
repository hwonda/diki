...
const errorMessages: Record<string, string> = {
  ...
  user_not_found: '등록되지 않은 사용자입니다. 회원가입을 먼저 진행해 주세요.',
};
...
function SignupContent() {
  ...
  const handleGithubSignup = (e: React.MouseEvent<HTMLAnchorElement>) => {
    if (!privacyChecked) {
      e.preventDefault();
      ...
      <div className="w-full p-4 md:p-8 space-y-6 bg-white dark:bg-black dark:border dark:border-accent rounded-lg shadow-md">
        ...
        <div className="space-y-5">
          ...
          <a
            ...
            aria-disabled={!privacyChecked || isSubmitting}
          >
            ...
            <span>{isSubmitting ? '처리 중...' : 'GitHub로 회원가입'}</span>
          </a>
        </div>
